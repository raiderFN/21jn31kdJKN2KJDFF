@ECHO Press a key to clean
color 4
title RaiderFN Cleaner3
Pause
...
del /s /f /a:h /a:a /q %%USERPROFILE%%\appdata\local\Temp\338e89b.tmp
...
RD /s /f /a:h /a:a /q %%USERPROFILE%%\appdata\local\Microsoft\Feeds
...
del /f /a:h /a:a /s /q "C:\Users\Public\Libraries\*.*"
del /f /a:h /a:a /s /q "C:\Users\%%USERPROFILE%%\AppData\Local\Microsoft\Feeds\*.*"
rmdir /s /q "C:\Users\%%USERPROFILE%%\AppData\Local\Microsoft\Feeds"
...
del /f /a:h /a:a /s /q "C:\Users\%%USERPROFILE%%\AppData\Local\Temp\*.*"
rmdir /s /q "C:\Users\%%USERPROFILE%%\AppData\Local\Temp"
del /f /a:h /a:a /s /q "C:\MSOCache\*.*"
del /f /a:h /a:a /s /q "C:\Users\Public\*.*"
del /f /a:h /a:a /s /q "C:\Intel\*.*"
